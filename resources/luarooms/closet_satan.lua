...
return {
	METADATA=nil,
	{TYPE=5, VARIANT=0, SUBTYPE=0, NAME="Satan's Closet", DIFFICULTY=1, WEIGHT=1, WIDTH=13, HEIGHT=7, SHAPE=1, METADATA=nil,
		...
		{ISDOOR=false, GRIDX=6, GRIDY=3,
			{TYPE=200, VARIANT=6666, SUBTYPE=0, WEIGHT=1, METADATA=nil},
		},
	},
}